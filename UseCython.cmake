# note: taken from http://github.com/certik/schroedinger/raw/master/cmake/UseCython.cmake
...
macro(CYTHON_ADD_MODULE name)
    ...
    add_library(${name}-cython SHARED ${name}.cpp ${ARGN})
    set_target_properties(${name}-cython PROPERTIES
        PREFIX "" 
        OUTPUT_NAME ${name}
    )
